function plot_some_raster_LFP_1channel(id_estimulos, id_BOS, estimulos, ...
    rasters, frequency_parameters, sr_lfp, tiempo_file, ntrials, puerto_canal, ...
    thr, directorio, spike_times)
