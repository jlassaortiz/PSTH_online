...
hist_aux = histcounts(dict_score(id_BOS).spikes_norm * ...
...
for i = id_estimulos % para cada estímulo
    ...
    histogram(dict_score(i).spikes_norm * 1000/frequency_parameters.amplifier_sample_rate , ...
        (1000/frequency_parameters.amplifier_sample_rate) * (-1000:(0.015* ... 
        frequency_parameters.amplifier_sample_rate):(tiempo_file*...
        frequency_parameters.amplifier_sample_rate)) );
    ylim([0 psth_max]);
    ...
    [sw_data, sw_times] = sliding_window(dict_score(i).spikes_norm, ...
        frequency_parameters.amplifier_sample_rate, ...
        t_window, step, tiempo_file);
