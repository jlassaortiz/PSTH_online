function thr = find_thr(raw_filtered, t0s_dictionary, tiempo_file, ...
...
%   Clustering. Neural Computation, 16(8), 1661?1687. 
...
t1 = t0s_dictionary(1).t0s(1,1) / frequency_parameters.board_adc_sample_rate ...
    * frequency_parameters.amplifier_sample_rate;
t2 = t0s_dictionary(1).t0s(2,1) / frequency_parameters.board_adc_sample_rate ...
    * frequency_parameters.amplifier_sample_rate;
t3 = t0s_dictionary(1).t0s(3,1) / frequency_parameters.board_adc_sample_rate ...
    * frequency_parameters.amplifier_sample_rate;
...
noise1 = raw_filtered(int64(t1 + tiempo_file_sample - duracion_BOS) : ...
    int64(t1 + tiempo_file_sample));
noise2 = raw_filtered(int64(t2 + tiempo_file_sample - duracion_BOS) : ...
    int64(t2 + tiempo_file_sample));
noise3 = raw_filtered(int64(t3 + tiempo_file_sample - duracion_BOS) : ...
    int64(t3 + tiempo_file_sample));
