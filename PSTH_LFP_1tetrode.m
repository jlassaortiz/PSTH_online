...
string(thr), "uV", "  |  ", "ntrials:", num2str(reshape(trials', 1, [])), "  |  ", ...
...
"  ntrials:", num2str(reshape(trials', 1, [])), "  t_inter_estimulo:", string(tiempo_file)) }, ...
'Interpreter','None')
legend
...
num2str(reshape(trials', 1, [])), "  t_inter_estimulo:", string(tiempo_file)) }, 'Interpreter','None')
legend
